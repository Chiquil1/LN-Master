...
export interface TtsSession
   ...
   * An `initialIndex` below zero appends unique paragraphs without interrupting
   * active playback. This keeps the public bridge compatible with generated
   * Nitro bindings while allowing a rolling multi-chapter buffer.
   */
  load(
