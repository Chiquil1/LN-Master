{
  let e, t, r, o, n, l, s, f, i, h, w, a, d, u, _, c, S, g, y, b, m, v, j, x, O;
  (s = Object.getPrototypeOf),
    ...
    (y = (e, t = S(), r) => {
      let n = { i: new Set(), u: new Set() },
        l = { f: e, s: t };
      (l.t = r ?? o?.push(l) ?? f), (t.val = d(e, n, t.rawVal));
      for (let e of n.i) {
        n.u.has(e) || (_(e), e.l.push(l));
      }
      return t;
    }),
    (b = (e, ...t) => {
    ...
    (m = (e, t, ...r) => {
      let [o, ...n] = s(r[0] ?? 0) === h ? r : [{}, ...r],
        f = e ? document.createElementNS(e, t) : document.createElement(t);
      for (let [e, r] of Object.entries(o)) {
        let o = t => (t ? Object.getOwnPropertyDescriptor(t, e) ?? o(s(t)) : l),
          n = t + ',' + e,
          h = i[n] ?? (i[n] = o(s(f))?.set ?? 0),
          a = e.startsWith('on')
            ? (t, r) => {
                let o = e.slice(2);
                f.removeEventListener(o, r), f.addEventListener(o, t);
              }
            : h
            ? h.bind(f)
            : f.setAttribute.bind(f, e),
          d = s(r ?? 0);
        e.startsWith('on') || (d === w && ((r = y(r)), (d = c))),
          d === c ? g(() => (a(r.val, r.h), f)) : a(r);
      }
      return b(f, n);
    }),
    ...
    (x = () => {
      ...
      do {
        t = new Set();
        for (let e of new Set(o.flatMap(e => (e.l = u(e.l))))) {
          y(e.f, e.s, e.t), (e.t = l);
        }
      } while (++r < 100 && (o = [...t]).length);
      let n = [...e].filter(e => e.rawVal !== e.h);
      e = l;
      for (let e of new Set(n.flatMap(e => (e.o = u(e.o))))) {
        j(e.t, g(e.f, e.t)), (e.t = l);
      }
      for (let e of n) {
        e.h = e.rawVal;
      }
    ...
    (O = {
      tags: new Proxy(e => new Proxy(m, v(e)), v()),
